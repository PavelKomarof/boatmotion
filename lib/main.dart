...
import 'package:boatmotion/model/camera_brightness_widget.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';

void main() {
// Фиксируем landscape ориентацию перед запуском приложения
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      home: Scaffold(
        ...
        // ),
        body: const CameraBrightnessWidget(),
      ),
    );
  }
}
